      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-20 lg:grid-cols-2">
        ...
        >
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-zinc-400">
            ...
            a Graphic Designer who turns ideas into bold visual experiences. From striking brand identities to social media creatives and experimental designs, I craft visuals that capture attention and build strong connections. Every project is a mix of creativity, strategy, and a passion for creating work that leaves a mark.
          </p>

          <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-500">
            Every project is built with intention, sharp attention to detail, and a bold creative approach that turns simple ideas into powerful visual experiences.
          </p>
        </motion.div>
        ...
        >
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:border-red-600/30">
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-red-600 to-red-700 p-8 transition-all duration-300 hover:-translate-y-2">
            <h3 className="text-3xl font-bold">Think Bold</h3>

            <p className="mt-3 text-white/80">
              Expressive visuals, fearless branding, and designs that leave a lasting impression.
            </p>
          </div>
        </motion.div>
      </div>
